...
ifeq ($(ARDUINO_CC_APP),)
    ifneq ($(wildcard $(APPLICATIONS_PATH)/ArduinoCC.app),)
        ifneq ($(shell grep -e '$(ARDUINO_IDE_RELEASE)' $(APPLICATIONS_PATH)/ArduinoCC.app/Contents/Java/lib/version.txt),)
...
ifeq ($(ARDUINO_CC_APP),)
    ifneq ($(wildcard $(APPLICATIONS_PATH)/Genuino.app),)
        ifneq ($(shell grep -e '$(ARDUINO_IDE_RELEASE)' $(APPLICATIONS_PATH)/Genuino.app/Contents/Java/lib/version.txt),)
...
ifneq ($(wildcard $(REDBEARLAB_NRF_1)/hardware/nRF51822),)
    ...
    REDBEARLAB_NRF_BOARDS  = $(REDBEARLAB_NRF_1)/hardware/nRF51822/$(REDBEAR_NRF_RELEASE)/boards.txt
endif
